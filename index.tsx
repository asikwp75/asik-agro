...
const testimonials = [
  {
    quote:
      "তেল এবং ঘি দুটোই অসাধারণ। খাঁটি পণ্যের জন্য আসিফ এগ্রো এখন আমার প্রথম পছন্দ। ডেলিভারিও খুব দ্রুত ছিল।",
    name: "সাকিব আহমেদ",
    location: "ঢাকা",
  },
  {
    quote:
      "অনেকদিন পর এমন খাঁটি সরিষার তেলের ঘ্রাণ পেলাম। রান্নার স্বাদটাই বদলে গেছে। ধন্যবাদ আসিফ এগ্রোকে।",
    name: "ফারিয়া ইসলাম",
    location: "চট্টগ্রাম",
  },
  {
    quote:
      "ঘি-টা মুখে দিতেই বোঝা যায় কতটা খাঁটি। প্যাকেজিংও খুব ভালো ছিল। আমি সবার জন্য আসিফ এগ্রো সাজেস্ট করবো।",
    name: "ইমরান হোসেন",
    location: "খুলনা",
  },
];
...
const WhyUsSection = () => {
  ...
  return (
    <section id="why-us" className="why-us-section">
      <h2 className="section-title">কেন আসিফ এগ্রো সেরা?</h2>
